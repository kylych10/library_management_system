  ...
  const testimonials = [
    {
      ...
      image: '👩‍🏫',
      rating: 5,
      text: 'Kitep Space has transformed the way I discover and access books. The online reservation system is incredibly convenient, and the collection is outstanding!',
      color: 'text-blue-600',
    },
    {
      name: 'Michael Chen',
