  ...
  extraReducers: (builder) => {
    builder
        ...
        .addCase(searchGenres.fulfilled, (state, action) => {
          ...
          state.activeGenres = action.payload.content || [];
        })
        ...
        .addCase(updateGenre.fulfilled, (state, action) => {
          ...
          const activeIndex = state.activeGenres.findIndex(g => g.id === action.payload.id);
          if (activeIndex !== -1) {
            state.activeGenres[activeIndex] = action.payload;
          }
